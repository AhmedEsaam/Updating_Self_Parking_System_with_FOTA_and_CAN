...
void MSPI1_voidInit(void)
{
	...
	MGPIO_ErrSetPinMode(MSPI1_MISO_PORTPIN, GPIO_ALTERNATE_FUNCTION); // PA6 MISO
	...
	MGPIO_ErrSetPinOutputSpeed(MSPI1_MISO_PORTPIN, GPIO_LOW_SPEED);
	MGPIO_ErrSetPinOutputSpeed(MSPI1_SCK_PORTPIN, GPIO_LOW_SPEED);

	MGPIO_ErrSetPinAlternateFunction(MSPI1_MISO_PORTPIN, MGPIO_AF5);
	...
	MGPIO_ErrSetPinPullUpPullDown(MSPI1_NSS_PORTPIN, GPIO_PULL_DOWN);
